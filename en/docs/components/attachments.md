...
!!! abstract "Overview"
    ...
    **Attachments** is a component that allows you to upload various media (pictures, videos etc.) on the device management screen.
...
## Adding Attachments
1. Go to **Devices** and select a device to which you want to upload a media attachment.
...
4. Selected files will be uploaded to your server and associated with the selected device, available for preview and download in its **Attachments** tab.
