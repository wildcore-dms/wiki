...
!!! abstract "Огляд"
    Ця сторінка надає опис процесу реєстрації та встановлення **WildcoreDMS**.
...
!!! success "Вирішення:"
    ...
    3. Продовжте встановлення **WildcoreDMS**, виконавши команду `sudo wca-tool update`.
...
!!! success "Вирішення:"
    ...
    Зверніться до офіційної [документації **Docker**](https://docs.docker.com/engine/install/) с приводу детальних інструкцій. Переконайтеся у сумісності з вашою версією операційної системи, відповідно до документації, або у відсутності застарілих версій.
